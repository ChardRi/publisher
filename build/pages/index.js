...
publisher/mods/storage
publisher/pages/index

*/
;KISSY.add('publisher/mods/storage',function(S){
	var storage;
...
;KISSY.add('publisher/pages/index',function (S, Node, Base, XTemplate, UA, IO, Storage) {
    ...
    requires:['node','base','xtemplate','ua','io','../mods/storage']
});
